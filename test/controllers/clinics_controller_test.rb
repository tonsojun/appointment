...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post clinics_url, params: { clinic: { city: @clinic.city, name: @clinic.name, street_address: @clinic.street_address, zip: @clinic.zip } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { city: @clinic.city, name: @clinic.name, street_address: @clinic.street_address, zip: @clinic.zip } }
