...
role = Role.create([{name:"Admin", code:"admin"}, {name:"Default", code:"default"}, {name:"Physician", code:"physician"}])
User.create(email: "test@test.com", password: "123456", role_id: Role.find_by(code: "default"))
